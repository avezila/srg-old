...
export const changeFavoriteOK      = createAction('CHANGE_FAVORITE_OK')
export const addOfferToReport      = createAction('ADD_OFFER_TO_REPORT')
export const addOfferToReportOK    = createAction('ADD_OFFER_TO_REPORT_OK')
export const changeLayout          = createAction('CHANGE_LAYOUT')
export const loading               = createAction('LOADING')
export const tableScroll               = createAction('TABLE_SCROLL')